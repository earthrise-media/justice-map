...
export function getBrowser(): IBrowser {
    ...
    html.classList.toggle('mac', !browser.windows && (browser.ios || browser.mac));
    html.classList.toggle('windows', browser.windows && !browser.mac && !browser.ios);
    html.classList.toggle('mobile', browser.mobile);
    html.classList.toggle('firefox', browser.firefox);
    html.classList.toggle('safari', browser.safari);
    html.classList.toggle('ie', browser.ie);
